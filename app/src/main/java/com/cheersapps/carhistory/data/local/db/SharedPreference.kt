...
@Singleton
open class SharedPreference @Inject constructor(context: Context, private val objectMapper: ObjectMapper) {
    val sharedPreferences: SharedPreferences

    init {
        this.sharedPreferences = context.getSharedPreferences("cheersapps$NAME", Context.MODE_PRIVATE)
    }
    ...
    fun getDouble(key: String, defValue: Double): Double {
        ...
        return if (valueStr.isNotEmpty()) valueStr.toDouble() else 0.0
    }
    ...
    fun <T> getObject(key: String, valueType: Class<T>): T? {
        ...
        return if (str.isNotEmpty()) convertToObject(str, valueType) else null
    }
